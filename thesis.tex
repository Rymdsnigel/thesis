...
\def\thesistitle{Time critical synchronization of networked rendering} % Title of thesis
...
\include{chapter1/main} % What ch 1 is about, explaining the problem, what synch is etc
\include{chapter2/main} % What ch 2 is about, architecture and design choices of demo program
\include{chapter4/main} % What ch 3 is about, synchronizing the clients
\include{chapter3/main} % What ch 4 is about, the functionallity of the demo program.
\include{chapter5/main} % Conclusions, suggested improvements
